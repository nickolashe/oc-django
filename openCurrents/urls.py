...
urlpatterns = [
    ...
    url(r'^confirm-purchase/$', views.ConfirmPurchaseView.as_view(), name='confirm-purchase'),
    url(r'^confirm-donation/$', views.ConfirmDonationView.as_view(), name='confirm-donation'),
    url(r'^donation-confirmed/$', views.DonationConfirmedView.as_view(), name='donation-confirmed'),
    ...
    url(r'^member-activity/$', views.MemberActivityView.as_view(), name='member-activity'),
